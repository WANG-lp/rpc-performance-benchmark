...
#  THRIFT_NB_LIBRARIES, libraries to link
...
find_path(THRIFT_INCLUDE_DIR
    ...
    HINTS
        ...
        /usr/local
        /opt/local
	/mnt/lustre/share/senseagent_client
    PATH_SUFFIXES
        include
)
...
# prefer the thrift version supplied in THRIFT_HOME
find_library(THRIFT_NB_LIBRARIES
    NAMES
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(THRIFT DEFAULT_MSG THRIFT_LIBRARIES THRIFT_NB_LIBRARIES THRIFT_INCLUDE_DIR THRIFT_COMPILER)
mark_as_advanced(THRIFT_LIBRARIES THRIFT_NB_LIBRARIES THRIFT_INCLUDE_DIR THRIFT_COMPILER THRIFT_VERSION_STRING)
